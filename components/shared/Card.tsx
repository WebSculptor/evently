  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      ...
      {isEventCreator && !hidePrice && (
        <div className="absolute right-2 top-2 flex flex-col gap-4 rounded-xl bg-white p-3 shadow-sm transition-all border">
      ...
      <div className="flex min-h-[230px] flex-col gap-3 p-5 md:gap-4 border-t">
        {!hidePrice && (
        ...
        <Link
          href={`/events/${event?._id}`}
          className="p-medium-16 md:p-medium-20 line-clamp-2 text-black"
        >
          {event.title}
        </Link>
